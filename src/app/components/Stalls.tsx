...
export function Stalls({ onStallClick }: StallsProps) {
  ...
  const stalls: StallData[] = [
    ...
    },
    {
      ...
      highlights: ['Oreo Milkshake', 'Chocolate Milkshake', 'KitKat Milkshake', 'Strawberry Milkshake', 'Falooda (Vanilla, Butterscotch, Chocolate)', 'Badam Milk'],
      location: 'Sports Ground',
    },
    {
      ...
      highlights: ['Paneer Sandwich', 'Chicken Sandwich', 'PBJ Sandwich', 'Veg Burger', 'Chicken Burger'],
      location: 'Sports Ground',
    },
    {
      id: 'soft-drinks',
      ...
      highlights: ['Thums Up', 'Sprite', 'Coke', 'Diet Coke'],
      location: 'Sports Ground',
    },
    {
      id: 'water-bottles',
    ...
    },
    {
      ...
      title: 'PANIPURI',
      category: 'Snacks',
      description: 'Crispy puris with tangy flavored water and street food.',
      icon: Sparkles,
      color: '#ff00ff',
      borderColor: 'neon-border-purple',
      fullDescription: 'Enjoy the classic Indian street food.',
      highlights: ['Butter Pav Bhaji', 'Dahi Papdi', 'Sweet Puri', 'Dahi Puri', 'Masala Puri', 'Papdi Chat', 'Samosa Chat', 'Aloo Fry Chat', 'Pani Puri', 'Vada Pav', 'Bhel Puri'],
      location: 'Sports Ground',
    },
    {
      id: 'twisters',
    ...
    },
    {
      ...
      highlights: ['Lemon Sweet', 'Lemon Salt', 'Mango', 'Blueberry', 'Orange'],
      location: 'Sports Ground',
    },
    {
      id: 'ice-cream',
    ...
    },
    {
      ...
      title: 'BROWNIES',
      category: 'Desserts',
      description: 'Freshly baked brownies, cupcakes, muffins and cakes.',
      icon: Sparkles,
      color: '#ff00ff',
      borderColor: 'neon-border-purple',
      fullDescription: 'Indulge in fudgy brownies and delicious cakes.',
      highlights: ['Jar Cakes', 'Brownies', 'Brownies with Ice Cream', 'Chocolate Truffle Pastry', 'Vanilla Pastry', 'Cupcakes', 'Muffins', 'Kunafa', 'Tea Cakes', 'Apricot Delight'],
      location: 'Sports Ground',
    },
    {
      id: 'momos',
      ...
      highlights: ['Veg Momos', 'Paneer Momos', 'Chicken Momos', 'Chilli Oil Momos', 'Korean Momos'],
      location: 'Sports Ground',
    },
    {
      id: 'ice-gola',
    ...
    },
    {
      ...
      highlights: ['Rings', 'Chains', 'Bracelets', 'Earcuffs', 'Necklace', 'Hair accessories', 'Mystery box'],
      location: 'Sports Ground',
    },
    {
      ...
      highlights: ['Strawberry Chocolate Bowl', 'Only Strawberry Chocolate', 'Only Cake Chocolate', 'Chocolate Cake Bowl', 'Customize Your Own Bowl (Strawberry, Cake, Marshmallow, Oreo, KitKat, Sprinkles, Choco Chips)', 'Marshmallow Chocolate Bowl'],
      location: 'Sports Ground',
    },
    {
      id: 'churros-cheesecake-donuts',
      title: 'CHURROS, CHEESECAKE & DONUTS',
      category: 'Desserts',
      description: 'Delicious churros, cheesecake and donuts.',
      icon: Sparkles,
      color: '#ff1493',
      borderColor: 'neon-border-pink',
      fullDescription: 'Indulge in sweet treats - churros, cheesecake, and donuts.',
      highlights: ['Chocolate Bowl Churros', 'Cheesecake', 'Biscoff', 'Nutella Bomboloni', 'Bread Roll', 'Chocolate Fudge', 'Cake Pops', 'Tanghulu', 'Chocolate Mousse', 'Gulab Jamun'],
      location: 'Sports Ground',
    },
    {
      id: 'chicken-pakodi',
      ...
      highlights: ['Chicken Pakodi', 'Egg Lollipop', 'Spicy', 'Crispy', 'Hot & Fresh'],
      location: 'Sports Ground',
    },
    {
      id: 'frozen-foods',
    ...
    },
    {
      ...
      highlights: ['Chicken BBQ', 'Paneer BBQ'],
      location: 'Sports Ground',
    },
    {
      id: 'games-1',
